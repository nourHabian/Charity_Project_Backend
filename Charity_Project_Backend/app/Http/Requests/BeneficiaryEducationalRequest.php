...
class BeneficiaryEducationalRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'needed_educational_help' => ['required', 'array', 'min:1'],
            'needed_educational_help.*' => ['required', 'string', 'exists:supplies,name'],
